            ...
            {data?.map(result => <>
                ...
                >
                    ...
                    >
                        ...
                        <Descriptions.Item span={3} label="استاندارد آزمون">
                            {result.Title}
                        </Descriptions.Item>
                        <Descriptions.Item span={6} label="توضیحات">
                            {result.Result_Desc}
                        </Descriptions.Item>
                        ...
                        <Descriptions.Item span={3} label="شماره اظهار نامه">
                            {result.Material_Import_Declaration_Number}
                        </Descriptions.Item>
                        <Descriptions.Item span={3} label="کد ملی تامین کننده">
                            {result.Material_Supply_National_Code}
                        </Descriptions.Item>
                        <Descriptions.Item span={3} label="در صد استفاده ماده اولیه">
                            {result.Material_Usage_Percentage}
                        </Descriptions.Item>
                        <Descriptions.Item span={6} label="میزان مصرف کل برای یک واحد تولیدی(کیلوگرم)">
                            {result.Material_Unit_Consumption}
                        </Descriptions.Item>
                        <Descriptions.Item label="تعداد فاکتور آزمون">
                            {result.Test_Item_Count}
                        </Descriptions.Item>
                        <Descriptions.Item span={6} label="ایرانکد">
                            {result.Material_Supply_Iran_Code}
                        </Descriptions.Item>
                        <Descriptions.Item span={6} label="آدرس تامین کننده">
                            {result.Material_Supply_Address}
                        </Descriptions.Item>
                        <Descriptions.Item span={3} label="تجدید پذیر">
                            {result.Result_Renewable}
                        </Descriptions.Item>
                    </Descriptions>
                </Card>
