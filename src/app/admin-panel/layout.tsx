...
const items: MenuProps["items"] = [
  getMenuItem("محصول", "management", null, [
    getMenuItem(
      <Link href={"/admin-panel/category-list"} className="text-sm">
        لیست دسته بندی
      </Link>,
      "category-list",
    ...
    getMenuItem(
      <Link href={"/admin-panel/products-list"} className="text-sm">
        لیست محصولات
      </Link>,
      "products-list",
    ...
    getMenuItem(
      <Link href={"/admin-panel/products-factor"} className="text-sm">
        فاکتور محصول
      </Link>,
      "products-factor",
