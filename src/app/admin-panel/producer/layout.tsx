...
const stepLinks: { number: number; href: string }[] = [
    {number: 0, href: "/admin-panel/producer/production-unit"},
    {number: 1, href: "/admin-panel/producer/managerial"},
    {number: 2, href: "/admin-panel/producer/personnel"},
    {number: 3, href: "/admin-panel/producer/license"},
    {number: 4, href: "/admin-panel/producer/calls"},
