...
export default function PrimaryAddBoxTable({ setModalVisible }: { setModalVisible: any }) {
        ...
        <>
            <div className="box-border w-full mt-8 p-6">
                <div className="flex justify-between items-center">
                    <Typography className='max-md:text-sm max-md:font-normal font-medium text-base p-2 text-gray-901'>لیست جعبه ها</Typography>
                    <Button
            ...
            >
                <p>آیا از حذف این جعبه مطمئن هستید؟</p>
            </Modal>
            {/* ویرایش */}
            <Modal
                width={800}
...
const data: DataType[] = [
    {
        ...
        Row: 1,
        ProductName: "123456",
        TrackingCode: "مازندران",
        ConfirmedRequestCode: "فعال",
    },
    {
        key: "2",
        Row: 2,
