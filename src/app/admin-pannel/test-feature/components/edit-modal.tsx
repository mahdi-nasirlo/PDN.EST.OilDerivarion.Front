...
export default function EditModal(
    ...
    const { isMutating, trigger } = useSWRMutation("/TestItemDetail/Update", mutationFetcher)
    ...
    const {
        data,
        isLoading
    } = useSWR(["/TestItemDetail/Get", { uid: recordToEdit?.Uid }], ([url, arg]) => listFetcher(url, { arg }));
