...
export default function Home(props: PropType) {
  ...
  const dataConfirmRequest = useSWR("/RequestDetail/GetAllProductAndOilExpertOpinion", (url) => listFetcher(url, {arg: {uid: props.params.uid}}))
  ...
  return (
      <>
        <div className="box-border w-full p-6">
          ...
          {data && <Divider/>}
          <WorkFlowConfirmProductTable dataSource={dataConfirmRequest.data} isLoading={dataConfirmRequest.isLoading}
