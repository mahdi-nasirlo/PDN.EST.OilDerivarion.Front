...
import useRequestDetailCreateSamtExpertOpinion from "../../../../../../hooks/requestDetail/useRequestDetailCreateSamtExpertOpinion";
...
const apiData = apiUrl.WorkFlowRequest.step24;
...
export default function Home(props: PropType) {
  ...
  const dataConfirmRequest = useSWR(
    "/RequestDetail/GetAllProductAndSamtExpertOpinion",
