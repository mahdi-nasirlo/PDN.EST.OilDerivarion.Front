...
export default function PrimaryRequestsDetailsForm({task_id, step_key}: { task_id: string, step_key: string }) {

    const [form] = useForm()

    const {data: requestMaster} = useSWR<RequestMaster>("/RequestMaster/Get", (url) => listFetcher(url, {
        arg: {
            "uid": task_id,
            "stepKey": step_key
        }
    ...
    return (
        <div>
            <Form form={form}>
                <Row gutter={[32, 1]}>
                    <Col xs={24} md={24}>
                        <Form.Item wrapperCol={{span: 24}} labelCol={{span: 24}} name="lastName"
                ...
                <Row gutter={[32, 1]}>
                    <Col xs={24} md={24}>
                        <Form.Item wrapperCol={{span: 24}} labelCol={{span: 24}} name="processDescription"
                ...
                <Row gutter={[32, 1]}>
                    ...
                    <Col xs={24} md={12}>
                        <Form.Item wrapperCol={{span: 24}} labelCol={{span: 24}} name="lastName" label="ضایعات">
                            <Input size="large" placeholder="هیدروکربن سبک" disabled/>
                        </Form.Item>
                    </Col>
                </Row>
