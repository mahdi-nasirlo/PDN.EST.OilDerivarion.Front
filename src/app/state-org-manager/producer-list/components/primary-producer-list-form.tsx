...
export default function PrimaryProducerListForm() {
    return (
            ...
            <div className="box-border w-full p-6">
                <Form name="form_item_path" layout="vertical">
                    ...
                    <Row gutter={[16, 16]}>
                        ...
                        <Col xs={24} md={8}>
                            <Form.Item name="year-establishment" label="نوع مالکیت ">
                                <Select size="large" placeholder="انتخاب کنید" />
                            </Form.Item>
                        </Col>
                        <Col xs={24} md={8}>
                            <Form.Item name="year-establishment" label="وضعیت حساب کاربری ">
                                <Select size="large" placeholder="انتخاب کنید" />
                            </Form.Item>
                        </Col>
                    </Row>
